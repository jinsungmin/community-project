...
async function create(options) {
    try {
        return await models_1.Comment.create(options);
    }
    catch (e) {
...
async function findAll(options) {
    try {
        return await models_1.Comment.findAll(options);
    }
    catch (e) {
        throw e;
    }
...
async function findOne(id) {
    try {
        const comment = await models_1.Comment.findOne({ id });
        if (comment)
            return comment;
...
async function update(options) {
    ...
    try {
        const comment = await models_1.Comment.updateOne(options, connection);
...
async function deleteOne(options) {
    try {
        const ret = await models_1.Comment.deleteOne(options.id);
        if (!ret)
            throw new Error('not_found');
    }
    catch (e) {
